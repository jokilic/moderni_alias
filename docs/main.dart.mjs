...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1282: (x0,x1) => x0.removeAttribute(x1),
      _1287: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1288: (x0,x1) => x0.canShare(x1),
      _1289: (x0,x1) => x0.share(x1),
      _1294: x0 => ({files: x0}),
      _1297: x0 => x0.click(),
      _1298: x0 => x0.remove(),
      _1299: () => ({}),
      _1300: (x0,x1,x2) => new File(x0,x1,x2),
      _1301: x0 => x0.load(),
      _1302: x0 => x0.play(),
      _1303: x0 => x0.pause(),
      ...
      _1318: (x0,x1) => x0.setSinkId(x1),
      _1319: (x0,x1,x2) => x0.call(x1,x2),
      _1320: (x0,x1,x2,x3,x4,x5) => x0.call(x1,x2,x3,x4,x5),
      _1321: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      ...
      _1328: (x0,x1,x2,x3,x4,x5,x6) => x0.call(x1,x2,x3,x4,x5,x6),
      _1329: x0 => globalThis.Wakelock.toggle(x0),
      _1338: (x0,x1) => x0.getItem(x1),
      _1340: (x0,x1,x2) => x0.setItem(x1,x2),
      _1341: () => globalThis.removeSplashFromWeb(),
      _1342: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1343: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1346: x0 => x0.call(),
      _1347: Date.now,
      ...
      _1365: (x0,x1,x2) => x0.register(x1,x2),
      ...
      _1392: (a, s) => a.join(s),
      _1393: (a, s, e) => a.slice(s, e),
      _1395: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1396: a => a.length,
      _1397: (a, l) => a.length = l,
      _1398: (a, i) => a[i],
      _1399: (a, i, v) => a[i] = v,
      _1401: o => {
      ...
      _1402: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1424: (t, s) => t.set(s),
      _1425: l => new DataView(new ArrayBuffer(l)),
      _1426: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1427: o => o.byteLength,
      _1428: o => o.buffer,
      ...
      _1476: (x0,x1,x2) => x0.transaction(x1,x2),
      _1477: (x0,x1) => x0.objectStore(x1),
      _1478: (x0,x1) => x0.getAllKeys(x1),
      _1479: (x0,x1) => x0.getAll(x1),
      _1481: (x0,x1) => x0.delete(x1),
      _1482: (x0,x1,x2) => x0.put(x1,x2),
      _1484: x0 => x0.close(),
      _1486: (x0,x1,x2) => x0.open(x1,x2),
      _1487: (x0,x1) => x0.contains(x1),
      _1490: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1501: () => new AbortController(),
      _1502: x0 => x0.abort(),
      _1503: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1504: (x0,x1) => globalThis.fetch(x0,x1),
      _1505: (x0,x1) => x0.get(x1),
      _1506: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1506(f,arguments.length,x0,x1,x2) }),
      _1507: (x0,x1) => x0.forEach(x1),
      _1508: x0 => x0.getReader(),
      _1509: x0 => x0.read(),
      _1510: x0 => x0.cancel(),
      ...
      _1513: x0 => x0.openCursor(),
      _1514: x0 => x0.continue(),
      ...
      _1517: x0 => globalThis.URL.createObjectURL(x0),
      _1519: x0 => ({type: x0}),
      _1520: (x0,x1) => new Blob(x0,x1),
      _1521: () => new XMLHttpRequest(),
      _1522: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1523: x0 => x0.send(),
      _1525: () => new FileReader(),
      _1526: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1527: (x0,x1) => x0.item(x1),
      ...
      _1540: (x0,x1) => x0.appendChild(x1),
      _1544: (x0,x1) => x0.key(x1),
      _1554: (s, m) => {
        try {
      ...
      _1570: o => o.length,
      _1572: (o, i) => o[i],
      _1573: f => f.dartFunction,
      _1574: () => ({}),
      _1575: () => [],
      _1577: () => globalThis,
      _1578: (constructor, args) => {
      ...
      _1580: (o, p) => o[p],
      _1581: (o, p, v) => o[p] = v,
      _1582: (o, m, a) => o[m].apply(o, a),
      _1584: o => String(o),
      _1585: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1586: o => {
      ...
      _1587: o => [o],
      _1588: (o0, o1) => [o0, o1],
      _1589: (o0, o1, o2) => [o0, o1, o2],
      _1590: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1613: (o, p) => o[p],
      _1616: x0 => x0.random(),
      _1617: (x0,x1) => x0.getRandomValues(x1),
      _1618: () => globalThis.crypto,
      _1619: () => globalThis.Math,
      _1620: Function.prototype.call.bind(Number.prototype.toString),
      _1621: Function.prototype.call.bind(BigInt.prototype.toString),
      _1622: Function.prototype.call.bind(Number.prototype.toString),
      _1623: (d, digits) => d.toFixed(digits),
      _1718: (x0,x1) => { x0.responseType = x1 },
      _1719: x0 => x0.response,
      _1794: x0 => x0.style,
      _2153: (x0,x1) => { x0.download = x1 },
      _2178: (x0,x1) => { x0.href = x1 },
      _2366: x0 => x0.videoWidth,
      _2367: x0 => x0.videoHeight,
      _2371: (x0,x1) => { x0.playsInline = x1 },
      _2396: x0 => x0.error,
      _2397: x0 => x0.src,
      _2398: (x0,x1) => { x0.src = x1 },
      _2406: (x0,x1) => { x0.preload = x1 },
      _2407: x0 => x0.buffered,
      _2410: x0 => x0.currentTime,
      _2411: (x0,x1) => { x0.currentTime = x1 },
      _2412: x0 => x0.duration,
      _2417: (x0,x1) => { x0.playbackRate = x1 },
      _2424: (x0,x1) => { x0.autoplay = x1 },
      _2426: (x0,x1) => { x0.loop = x1 },
      _2428: (x0,x1) => { x0.controls = x1 },
      _2430: (x0,x1) => { x0.volume = x1 },
      _2432: (x0,x1) => { x0.muted = x1 },
      _2447: x0 => x0.code,
      _2448: x0 => x0.message,
      _2521: x0 => x0.length,
      _3024: x0 => x0.src,
      _3025: (x0,x1) => { x0.src = x1 },
      _3027: (x0,x1) => { x0.type = x1 },
      _3031: (x0,x1) => { x0.async = x1 },
      _3033: (x0,x1) => { x0.defer = x1 },
      _3045: (x0,x1) => { x0.charset = x1 },
      _3494: () => globalThis.window,
      _3533: x0 => x0.self,
      _3534: x0 => x0.document,
      _3556: x0 => x0.navigator,
      _3813: x0 => x0.indexedDB,
      _3820: x0 => x0.localStorage,
      _3943: x0 => x0.userAgent,
      _3944: x0 => x0.vendor,
      _4151: x0 => x0.length,
      _6055: x0 => x0.type,
      _6056: x0 => x0.target,
      ...
      _6108: x0 => x0.length,
      _6151: x0 => x0.baseURI,
      _6168: () => globalThis.document,
      _6250: x0 => x0.body,
      _6252: x0 => x0.head,
      _6582: (x0,x1) => { x0.id = x1 },
      _6609: x0 => x0.children,
      _7928: x0 => x0.value,
      _7930: x0 => x0.done,
      _8114: (x0,x1) => { x0.type = x1 },
      _8130: x0 => x0.result,
      _8627: x0 => x0.url,
      _8629: x0 => x0.status,
      ...
      _10089: x0 => x0.result,
      _10090: x0 => x0.error,
      _10095: (x0,x1) => { x0.onsuccess = x1 },
      _10097: (x0,x1) => { x0.onerror = x1 },
      _10101: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10119: x0 => x0.version,
      _10120: x0 => x0.objectStoreNames,
      _10187: x0 => x0.key,
      _10190: x0 => x0.value,
      _10750: (x0,x1) => { x0.border = x1 },
      _11028: (x0,x1) => { x0.display = x1 },
      _11192: (x0,x1) => { x0.height = x1 },
      _11882: (x0,x1) => { x0.width = x1 },
      _12250: x0 => x0.name,
      _12251: x0 => x0.message,
