...
class ModerniAliasWebsites {
  ...
  static const senIconWebsite = 'https://fonts.google.com/specimen/Sen';
  static const flaticonWebsite = 'https://www.flaticon.com';
...
class ModerniAliasDurations {
  ...
  static const verySlowAnimation = Duration(milliseconds: 1600);
  static const fastAnimation = Duration(milliseconds: 200);
  static const veryFastAnimation = Duration(milliseconds: 100);
}
